  ...
  return (
    <div className={`walking-robot-container ${className}`}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Hips: en el medio (100, 135) */
        #hips {
          transform-origin: 100px 135px;
        }

        /* Brazo izquierdo: pivota en el hombro, que está en (75, 80) */
        #leftArmGroup {
        ...
        /* Brazo derecho: pivota en el hombro, que está en (125, 80) */
        #rightArmGroup {
        ...
        /* Pierna izquierda: pivota en la cadera (85, 135) */
        #leftLegGroup {
        ...
        /* Tobillo izq: (85, 225) */
        #leftAnkle {
          transform-origin: 85px 225px;
        }

        /* Pierna derecha: pivota en la cadera (115, 135) */
        #rightLegGroup {
          transform-origin: 115px 135px;
        }
        /* Rodilla der: (115, 180) */
        #rightKnee {
          transform-origin: 115px 180px;
        }
        /* Tobillo der: (115, 225) */
        #rightAnkle {
