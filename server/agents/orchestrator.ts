...
import { SpecializedAgent } from './specialized/base-agent';
import { AgentRequest, AgentResponse, OpenAITool } from './types';
...
// Usamos la clase base de SpecializedAgent importada desde './specialized/base-agent'
